...
/**
 * @swagger
 * path: /api/users/get-listing-patients/{listing_id}
 * operations:
 *   -  httpMethod: GET
 *      summary: Get all states list
 *      notes: Get all states list
...
/**
 * @swagger
 * path: /api/users/appointment-request-to-admin
 * operations:
 *   -  httpMethod: POST
 *      summary: Appointment request to admin
 *      notes: Returns a success message
 *      responseClass: AppointmentRequest
 *      nickname: appointmentRequest
 *      consumes: 
 *        - text/html
 *      parameters:
 *        - name: body
...
/**
 * @swagger
 * path: /api/users/get-curruent-five-appointment
 * operations:
 *   -  httpMethod: GET
 *      summary: User Logout
 *      notes: User Logout
